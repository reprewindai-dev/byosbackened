...
from apps.api.routers import admin_payments
...
from apps.api.routers import stripe_billing, admin_dashboard, user_dashboard, dashboard_auth
...
# Game routes
from apps.api.routers.admin_dashboard import router as admin_dashboard
from apps.api.routers.user_dashboard import router as user_dashboard
from apps.api.routers.dashboard_auth import router as dashboard_auth
from apps.api.routers.executive_dashboard import router as executive_dashboard_router

# Include routers with proper prefixes
app.include_router(admin_dashboard, prefix="/api/v1", tags=["admin-dashboard"])
app.include_router(user_dashboard, prefix="/api/v1", tags=["user-dashboard"])
app.include_router(dashboard_auth, prefix="/api/v1", tags=["dashboard-auth"])
app.include_router(executive_dashboard_router, prefix="/api/v1", tags=["executive-dashboard"])
...
app.include_router(user_dashboard.router, prefix=settings.api_prefix)
