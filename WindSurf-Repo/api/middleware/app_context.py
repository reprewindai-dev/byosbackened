        ...
        try:
            ...
            if not app:
                raise HTTPException(
                    ...
                    detail=f"App '{app_slug}' not found or inactive",
                )
            ...
            if not workspace:
                raise HTTPException(
                    status_code=status.HTTP_404_NOT_FOUND,
                    detail=f"Workspace '{workspace_id}' not found or inactive",
                )
            ...
            if not app_workspace:
                raise HTTPException(
                    ...
                    detail=f"Workspace does not have access to app '{app_slug}'",
                )
