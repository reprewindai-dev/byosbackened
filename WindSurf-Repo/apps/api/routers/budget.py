    ...
    return [
        {
            ...
            "remaining": str(b.amount - b.current_spend),
            "percent_used": float((b.current_spend / b.amount * 100) if b.amount > 0 else 0),
            "forecast_exhaustion_date": (
                b.forecast_exhaustion_date.isoformat() if b.forecast_exhaustion_date else None
            ),
...
async def get_budget_forecast(
    ...
    return {
        ...
        "forecast_exhaustion_date": (
            check.forecast_exhaustion_date.isoformat() if check.forecast_exhaustion_date else None
        ),
