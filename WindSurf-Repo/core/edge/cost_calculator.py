...
class EdgeCostCalculator:
    ...
    def calculate_region_cost(
        ...
        compute_cost = (
            Decimal(str(compute_time_seconds)) / Decimal("3600")
        ...
        transfer_cost = (
            Decimal(str(data_transfer_bytes)) / Decimal(1024**3)
    ...
    def get_cheapest_region(
        ...
        cheapest_region = min(costs.keys(), key=lambda r: costs[r]["total_cost"])
