...
class ExecutiveOverview(BaseModel):
    ...
    controls: Dict[str, Any] = Field(..., description="Control switches and guardrails")
...
class ExecutiveDashboardService:
    ...
    async def get_overview(self, days: int = 30) -> ExecutiveOverview:
        ...
        return ExecutiveOverview(
            ...
            controls={
                "switches": [
                    {"name": "AI Processing", "enabled": True, "provider": "OpenAI"},
...
if __name__ == "__main__":
    ...
    logger.info("Executive dashboard: http://localhost:8002")
