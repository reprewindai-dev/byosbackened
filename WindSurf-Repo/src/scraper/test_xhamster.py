"""Test script for XHamster scraper."""
...
async def test_scraper():
    """Test the XHamster scraper."""
    scraper = XHamsterScraper()

    try:
        print("=" * 60)
        print("XHamster Scraper Test")
        print("=" * 60)
        print()
        ...
        trending = await scraper.get_trending(category="lesbian", period="daily", limit=5)
