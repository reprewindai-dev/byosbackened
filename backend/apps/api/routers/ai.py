...
def _build_log_hash(*, log_id: str, workspace_id: str, user_id: str, operation_type: str, provider: str, model: Optional[str], input_hash: str, output_hash: str, cost: Decimal, created_at: datetime, previous_log_hash: Optional[str]) -> str:
    log_data = {
        "id": log_id,
