...
class SLOAlerts:
    ...
    def _check_latency_slo(
        ...
        return {
            ...
            "severity": "critical" if p95_latency > self.SLO_LATENCY_ALERT_THRESHOLD_MS * 1.5 else "medium",
            "message": (
    ...
    def _check_error_rate_slo(
        ...
        return {
            ...
            "severity": "critical" if error_rate > self.SLO_ERROR_RATE_ALERT_THRESHOLD * 2 else "medium",
            "message": (
    ...
    def _check_remediation_slo(
        ...
        remediated = db.query(Anomaly).filter(
