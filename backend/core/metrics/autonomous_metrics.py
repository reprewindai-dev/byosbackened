...
routing_decisions_total = Counter(
    ...
    ["workspace_id", "provider", "operation_type", "decision_type"],  # decision_type: ml, rule_based, fallback
)
...
ml_model_accuracy = Gauge(
    ...
    ["workspace_id", "model_type"],  # model_type: cost_predictor, quality_predictor, routing_optimizer
)
...
edge_routing_decisions_total = Counter(
    ...
    ["workspace_id", "region", "routing_reason"],  # routing_reason: latency, cost, data_residency, learned
)
