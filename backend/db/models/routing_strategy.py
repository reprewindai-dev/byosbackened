...
class RoutingStrategy(Base):
    ...
    exploration_rate = Column(Numeric(5, 4), nullable=True, default=0.1)  # Exploration vs exploitation
    
    # Strategy metadata
    strategy_type = Column(String, nullable=False, default="cost_optimized")  # cost_optimized, quality_optimized, speed_optimized, hybrid
